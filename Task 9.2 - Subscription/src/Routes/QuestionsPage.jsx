...
import QuestionPostCard from '../Components/QuestionPostCard';  // Use the specialized PostCard
    ...
    <div>
      ...
      <div className='posts-container'>
        {filteredPosts.map((post) => (
          <QuestionPostCard key={post.id} post={post} onPostDeleted={handlePostDeleted} />
        ))}
      </div>
    </div>
  );
