...
const PostPage = () => {
  ...
  const [description, setDescription] = useState('');  // Markdown content will be stored here
  const [tags, setTags] = useState('');
  const [markdownContent, setMarkdownContent] = useState(''); // For the markdown content
  ...
  const handleSubmitPost = async () => {
    ...
    try {
      const post = {
        title,
        description,  // Markdown content will be saved as description
        tags,
        imageUrl,
        postType,
  ...
  return (
    <div className="unique-container">
      ...
      <OutcomeCorrespond
        ...
        setMarkdownContent={setMarkdownContent} // Pass markdown content setter
      />
